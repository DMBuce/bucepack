...
template="""\
      - { type: item, weight: 1,  count: 1, item: glow_squid_ink,
          nbt: '{CustomModelData:%s,EntityTags:{ShowArms:1b,NoBasePlate:1b%s,Pose:{%s}},display:{Lore:[\\"\\\\\\"§r§a%s\\\\\\"\\"%s]}}'
        }\
"""
...
{'name': 'Glamer of the Hero', 'nbt': 'Body:[0f,0f,0f],Head:[15f,20f,0f],LeftArm:[4f,8f,235f],LeftLeg:[-15f,-20f,-15f],RightArm:[245f,0f,90f],RightLeg:[8f,20f,4f]'},
{'name': 'Glamer of Riposte', 'nbt': 'Body:[0f,0f,0f],Head:[-10f,0f,-5f],LeftArm:[-105f,0f,0f],LeftLeg:[7f,0f,0f],RightArm:[-100f,0f,0f],RightLeg:[-45f,0f,0f]'},
{'name': 'Glamer of the Zombie', 'nbt': 'Body:[0f,20f,0f],Head:[-5f,20f,0f],LeftArm:[8f,0f,-115f],LeftLeg:[-110f,55f,0f],RightArm:[0f,85f,110f],RightLeg:[0f,25f,-15f]'},
...
{'name': 'Glamer of the Rightward Cancan', 'nbt': 'Body:[0f,8f,0f],Head:[-4f,65f,0f],LeftArm:[15f,30f,-8f],LeftLeg:[0f,-75f,-8f],RightArm:[-100f,65f,0f],RightLeg:[4f,65f,8f]'},
]
