...
# revoke advancement
advancement revoke @s only bucepack:breeding_overhaul/trigger
...
#execute as @e[type=horse,tag=mutation,limit=1] run function bucepack:breeding_overhaul/debug

# adjust baby stats in 1t when it's born
schedule function bucepack:breeding_overhaul/breed 1t append
