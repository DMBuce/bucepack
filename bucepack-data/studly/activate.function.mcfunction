...
execute unless entity @e[type=horse,tag=mutation] run summon horse ~ -5 ~
execute positioned ~ -5 ~ as @e[type=horse,distance=..1,limit=1] run data merge entity @s {Age:-60,Silent:1,NoAI:1,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:999999,ShowParticles:0b}],Tags:["genes","mutation"]}
