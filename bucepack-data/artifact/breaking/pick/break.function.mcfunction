...
# mine blocks
execute if entity @s[tag=facing_x] run function bucepack:artifact/breaking/pick/break_yz
execute if entity @s[tag=facing_y] run function bucepack:artifact/breaking/pick/break_xz
execute if entity @s[tag=facing_z] run function bucepack:artifact/breaking/pick/break_xy
