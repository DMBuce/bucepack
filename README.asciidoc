...
TODO: document limitations of Breaking
* Doesn't work while sneaking
* Doesn't work if the block that was broken didn't drop an item
* Doesn't work with Unbreaking
...
inventory the first time they join the world. Unlike the other starter packs
here, it does not change the bonus spawn chest.
...
Mythic Enchantment: Stormcalling
...
Mythic Enchantment: Gravitation
