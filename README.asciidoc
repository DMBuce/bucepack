...
Moccasins can be crafted from 4 rabbit hide and 2 rabbit feet.
They give Speed II, Jump Boost II, and Step Assist.

Frost and Flood Boots can be crafted from 2 diamonds and 1 each of
powder snow, prismarine crystal, blue ice, and heart of the sea.
They have Frost Walker I and Depth Strider.

**Downloads**

.https://github.com/DMBuce/bucepack/releases/latest/download/gear_custom.zip[`gear_custom.zip`]
[%collapsible]
====
