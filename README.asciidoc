...
and Ravager. Whenever a player kills one of these mobs, it drops one
block chosen at random. Below is a summary of possible drops.

* **Dragon**: Jar of Dragon's Breath, Portal in a Jar, Enderman Plushie
* **Wither**: Jar of Nether Star, Jar of Magma Cream, Skull in a Jar
* **Elder Guardian**: Jar of Pufferfish, Beach Ball, Coconut
* **Ravager**: Jar of Enchanting, Iron Cube, Emerald Cube
//* **Warden**: Jar of Lava, Gold Cube, Diamond Cube
...
This is an addon pack for the <<boss-loot,Boss Loot>> datapack that
adds decorative blocks to boss loot.
...
This is an addon pack for the <<boss-loot,Boss Loot>> datapack that
adds modern blocks to boss loot.
...
* **Anytime**: Cheese, Garlic, Red Onion, Lemon, Bread, Jam
* **Dawn**: Coffee, Pancakes, Waffles, Donuts
* **Daytime**: Soda, Sandwich, Sushi, Soup
* **Dusk**: Pasta, Chocolate Cake, Burger, Picnic Basket
* **Nighttime**: Popcorn, Fried Chicken, Grapes, Ice Cream
...
This is an addon pack for the <<boss-loot,Boss Loot>> datapack that
adds blocks to boss loot based on the month and season within minecraft.
...
** **April**: Easter Basket
** **May**: R2-D2 Plushie
* **Summer**: Hermit Crab, Lime, Key Lime Pie
** **June**: Rainbow in a Jar
** **July**: Dynamite
** **August**: Hot Dog
