...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/decor_loot.zip[`decor_loot.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/modern_loot.zip[`modern_loot.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/food_loot.zip[`food_loot.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/seasonal_loot.zip[`seasonal_loot.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/relic_loot.zip[`relic_loot.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/starter_relic.zip[`starter_relic.zip`]
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/mythic_relics.zip[`mythic_relics.zip`]
...
shards aren't generating with enchantments in ancient city loot, run
 ...
 /datapack disable "file/mythic_relics.zip"
 /datapack enable "file/mythic_relics.zip" after "file/loot_overhaul.zip"
