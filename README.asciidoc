...
and these blocks don't block bookshelves from boosting the enchantment table.
...
//=== Deep Gate Network
//
//A lodestone compass and ender pearl can be applied to a goat horn in a
//smithing table.
//Playing the horn near the lodestone that the compass was linked to teleports
//the player to the lodestone.
//
//Playing the horn near a deep gate amplifies the horn's tune,
//allowing the player to teleport to the lodestone from any ancient city.
//
//Download:
//https://github.com/DMBuce/bucepack/releases[All Releases]
//
...
//=== Deep Broadcast Network
//
//Turns the reinforced deepslate structures at the center of ancient cities
//into broadcast devices
//that interact with shrieker sounds so as to summon players instead of wardens.
//
//These broadcast devices convert the sounds of nearby shriekers
//into a signal that compasses can modulate. The modulated signal resonates
//with the compass' corresponding spawn location, death point, or lodestone.
//
//When a player holding a recovery compass, compass, or lodestone compass
//steps on a shrieker near a broadcast device,
//the shrieker summons the player
//at the corresponding death point, lodestone, or world spawn.
//Shriekers can only summon players in the overworld this way.
//
//Download:
//https://github.com/DMBuce/bucepack/releases[All Releases]
//
