...
Makes the blast furnace produce three nuggets when melting down tools and armor.

**Downloads**

.https://github.com/DMBuce/bucepack/releases/latest/download/blasting_plentiful.zip[`blasting_plentiful.zip`]
[%collapsible]
====
