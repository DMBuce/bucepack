...
which adds more corporeal phantoms to The End.
...
By default, item tooltips display boons with light green text.
...
Glamers are enchantments that can be applied to item frames and/or armor
stands in the smithing table to give them effects such as invisibility or
illusory arms. They are identical to boons in every other way.
