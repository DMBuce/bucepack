...
Turns the overworld into a sky world with biomes.
Spawn is set to 0, 0 where there is a single bedrock block to stand on.
No other terrain generates.

Intended for use with packs like <<dripblock,DripBlock>> that add a custom
skyblock experience to the game.

Download:
https://github.com/DMBuce/bucepack/releases[All Releases]

Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/skyblock.zip[`skyblock.zip`]

==== DripBlock

When used with the <<skyblock,SkyBlock>> datapack,
this pack spawns you in a skyblock world on
a small island made of dripstone and water.
...
// ==== Hover Mode
//
// Makes more resources available in skyblock worlds where structures don't
// generate.
//
// * Wandering trader llamas drop a barrel containing loot from a random structure
// * End portal frames are craftable from 9 enderchests
