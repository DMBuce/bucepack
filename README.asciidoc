...
will continue to generate until you exit and re-enter the world, restart the
server, or run `/function bucepack:loot_overhaul/reset`
...
<<loot-overhaul,Loot Overhaul>>
datapack above. Each pack adds one additional item to the bonus spawn chest.
