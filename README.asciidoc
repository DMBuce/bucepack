...
* <<mythic-relics,Mythic Relics>>, <<deep-relics,Deep Relics>>, <<illusory-traders,Illusory Traders>>: Some relics
* <<archaeological-relics,Archaeological Relics>>, <<starter-relic,Starter Relic>>, <<ender-relic,Ender Relic>>: Some relics
...
Enhanced farming of crops and mobs.
...
Many plants can be placed and grown on cauldrons, composters, and decorated
pots.

image::https://i.imgur.com/5bFaiZC.png[Farmable]
...
* block.stone.step Bedrock Gremlin
* block.bone_block.place Bone Gremlin (2 variants)
* block.chest.open Chest Gremlin
* ui.stonecutter.take_result Crafty Gremlin
* block.furnace.fire_crackle Furnace Gremlin
* block.glass.break Ice Gremlin (2 variants)
* block.stone.place Lava Gremlin (2 variants)
* block.ancient_debris.place Scrap Gremlin
* entity.generic.explode TNT Gremlin
...
Any Profession:
* block.grass.place Gift Basket Golem
* item.book.page_turn Gift Golem (3 variants)

Armorer:
* block.copper.break Copper Golem (3 variants)
* block.blastfurnace.fire_crackle Metal Golem

Butcher:
* entity.cow.ambient Cow
* block.smoker.smoke Meat Golem
* entity.pig.ambient Meat Golem
* entity.pig.ambient Pig (2 variants)
* entity.sheep.ambient Sheep

Cartographer:
* entity.generic.drink Coconut Golem
* entity.generic.eat Kiwi Golem
* entity.generic.eat Lemon Golem
* entity.generic.eat Lime Golem
* block.grindstone.use Map Golem

Cleric:
* block.ender_chest.open Ender Golem
* block.honey_block.place Honey Golem
* entity.generic.eat Onion Golem
* ui.cartography_table.take_result Tome Golem

Farmer:
* entity.generic.eat Cheese Golem
* entity.generic.eat Grape Golem
* block.honey_block.slide Jam Golem (4 variants)
* block.wood.place Melon Golem
* entity.generic.eat Picnic Golem
* entity.generic.eat Pie Golem (5 variants)
* block.wood.place Pumpkin Golem
* entity.generic.eat Sandwich Golem

Fisherman:
* block.conduit.ambient.short Clam (3 variants)
* entity.cod.flop Fish
* entity.cod.flop Fish Golem (2 variants)
* entity.glow_squid.ambient Glow Squid
* entity.guardian.ambient_land Guardian
* entity.puffer_fish.blow_up Pufferfish
* entity.squid.ambient Squid
* block.barrel.close Storage Golem
* block.barrel.open Storage Golem (2 variants)
* entity.cod.flop Tail Golem

Fletcher:
* entity.arrow.shoot Fletching Golem
* block.grass.place Straw Golem (2 variants)
* entity.arrow.hit Target Golem

Leatherworker:
* block.stone.place Cauldron Golem
* item.bucket.empty Cauldron Golem
* item.bucket.empty_lava Cauldron Golem
* item.bucket.empty_powder_snow Cauldron Golem

Librarian:
* ui.cartography_table.take_result Book Golem (3 variants)
* block.enchantment_table.use Enchanted Golem (2 variants)

Mason:
* block.stone.place Brick Golem
* block.gravel.place Clay Golem
* block.stone.place Clay Golem (16 variants)
* block.stone.place Quartz Golem (3 variants)
* block.stone.place Stone Golem (7 variants)

Shepherd:
* entity.llama.swag Cloth Golem
* ui.loom.take_result Loom Golem
* block.wool.place Wool Golem (16 variants)

Toolsmith:
* block.smithing_table.use Smith Golem

Weaponsmith:
* block.grindstone.use Grind Golem (2 variants)
...
* block.amethyst_block.resonate Amp Roadie
* entity.allay.ambient_with_item Companion Cube
* block.stone_button.click_off Computron
* block.dispenser.dispense Dispenser of Justice
* entity.generic.eat Donut Girl (2 variants)
* block.amethyst_block.resonate Jukebox Hero
* block.glass.break Lamp Lover
* block.piston.contract Piston Guy (2 variants)
* block.stone_button.click_on Rubik (2 variants)
* block.stone_button.click_off Safety Joe
* block.stone.place Silent Observer
* block.piston.extend ToasterBot
* block.stone_button.click_off TV Boy
* ui.cartography_table.take_result Zip
...
//If this <<ordering-data-packs,addon pack>>
//is enabled and loaded after <<loot-overhaul,Loot Overhaul>>,
//<<archaeological-relic,Archaeological Relics>> rarely appear in chest loot. The chance varies depending on
...
enchantment that can be applied to a diamond pick, axe, shovel, or hoe
with a bottle o' enchanting in the
...
//with a bottle o' enchanting in a smithing table.
//
