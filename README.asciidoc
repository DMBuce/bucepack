...
They should be in this order (from top to bottom) in the Select Data Packs screen,
and in the _reverse_ of this order (left to right) in the output of `/datapack list`.
