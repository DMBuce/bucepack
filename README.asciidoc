...
Keep inventory with downsides. Players keep their inventory and lose all
experience when they die. The XP does not drop as orbs. In addition,
saturation does not heal players.

This datapack sets gamerules the first time it loads, so
if you want food to heal normally and just want to lose your levels and not
your inventory when you die, run `/gamerule naturalRegeneration true` after
install.
