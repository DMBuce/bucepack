...
// note guide comparison: https://i.imgur.com/inCcwta.png

Advanced Note Guide
-------------------

This is like the Note Guide pack, above, with the addition of a display that
shows the octave and the note's position on the
