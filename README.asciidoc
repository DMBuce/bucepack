...
quicksilver with Myth of Liquid Metal, a custom enchantment that can be
applied to a shield or sword in the smithing table. When placed in the
offhand, the sword transforms into a shield with Unbreaking III. When the
shield is placed in the main hand or deals damage, it transforms into a sword
with Sharpness V. Transforming resets all properties of the item including its
durability, extra enchantments, name, and banner pattern.
