...
[technical limitations](https://bugs.mojang.com/browse/MC-156411).
...
* End cities include loot from <<loot-overhaul,Loot Overhaul>>
  ...
  including fireworks and enchanted crossbows to serve as a ranged weapon,
...
and in the _reverse_ of this order in the Select Data Packs screen.
