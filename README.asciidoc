...
Reskins ravagers with a texture inspired by redstone golems
and the redstone monstrosity from Minecraft: Dungeons.

//image::https://i.imgur.com/bJEeUdc.png[Ravager]
image::https://i.imgur.com/V7miGki.png[Ravager]
image::https://i.imgur.com/gezAGDj.png[Ravager]
...
* blasting: tool → 3 nuggets
* blasting: armor → 3 nuggets
...
Minecarts can be smelted into nuggets or blasted into ingots.
...
A player holding a map or compass can see their coordinates.

A player holding a lodestone compass can see the distance to the lodestone.

A player holding a recovery compass can see the distance to their death point.
...
the display stops working for lodestone compasses and recovery compasses
