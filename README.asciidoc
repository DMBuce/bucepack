...
A new Molten Peaks biome generates
with several layers of smooth basalt on the surface
...
Caves above sea level in Stony Peaks, Stony Shores, and Molten Peaks
