...
Currently, this datapack just adds volcanic Molten Peaks biomes
that generate with several layers of smooth basalt on the surface
...
In the future, this datapack will have other features
that require sweeping changes to the overworld.
