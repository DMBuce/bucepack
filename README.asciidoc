...
In this pack, enderman can only pick up ferns, dead bushes, grass, flowers,
saplings, berry bushes, cacti, melons, pumpkins, red & brown mushrooms,
crimson & warped fungus & roots, and TNT.

Download: https://github.com/DMBuce/bucepack/releases

Build: `make gardnerendermen.zip`
...
All dragonproofed blocks are shown below.
...
of some entries like ore ingots. All loot table entries added by this pack are
a replacements for the entries that it removes.
...
Bonus spawn chests generate a more curated set of starter items: 3-5 cobble,
2-3 bread, 3-5 logs, a book & quill. The intention is to provide fewer items
overall that are more useful in a fresh world.

Food looted from chests depends on the structure its found in. Underground
structures have potatoes and carrots. Villager and illager structures have
pie, cookies, and cake instead. Ocean chests have salmon and cod. Desert
and jungle temples occasionally have honey.
...
chance to spawn a map leading to another End City. And so on.

Villages generate chainmail instead of iron armor.
End Cities generate only diamond gear rather than a mix of diamond and iron.
Woodland Mansions can rarely generate a conduit, beacon, or shulker box.
...
haven't eaten, planted, or otherwise used the items shown below, you have a
chance to find them in End City and Woodland Mansion chests. There is also a
small chance to generate Suspcious Stew so that once you've collected all
these items, you'll get Suspicious Stew instead of just nothing.
...
bartering is unchanged and still generates Soul Speed 100% of the time.
...
Some highlights of items you might rarely find... It's possible to find any
sapling type in villages and cocoa beans in savanna villages.
You get petrified oak slabs in underground structures, ender eyes in strongholds
and temples, xp bottles throughout the world, prismarine/scutes/nautilus
shells in ocean chests, tridents in treasure chests, or blackstone/quartz in
...
The intention is that although you won't be able to loot any of these things
reliably, when you do, it will make your world feel just a bit more special.
