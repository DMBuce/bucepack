...
//Some relics have mythic enchantments on them. Unlike other relics, if a mythic
//relic's datapack is uninstalled, its effects cease to function, becoming mere
//myth.
//
