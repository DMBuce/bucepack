...
Makes hoes able to harvest blocks normally obtained by breaking them with shears.

TODO: document this better, add a picture
...
Lets you light portals with torches.

Due to implementation details,
this pack changes a few other things about torches:

* Torches get squished by falling blocks
* Torches are treated like fire by mob pathfinding
* Splash water potions destroy torches
* Entities in torches start on fire maybe?

TODO: document this better, add a picture

Download: https://github.com/DMBuce/bucepack/releases

Build: `make torched_portals.zip`
...
This is an addon to the Loot Overhaul pack above.
...
`lootoverhaul.zip/data/minecraft/loot_tables/chests/spawn_bonus_chest.json`
and change the `expand` line in the `starter_item` tag entry so that it says
