...
the octave, the note's position on a keyboard, and its position on the
...
image::https://i.imgur.com/razfQLj.png[Note Guide]
...
* Facing West: bass, snare, hat, basedrum
* Facing North: harp, guitar, iron_xylophone, xylophone
* Facing South: cow_bell, chime, flute, bell
* Facing East: didgeridoo, pling, banjo, bit
