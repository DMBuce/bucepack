...
**Relic of Mining**:
When mined with Haste II,
Deepslate Emerald Ore drops a gold nugget
with Myth of Darkvision and Myth of Greed,
...
At 250 charge, the enchantment provides one minute of Haste II,
and the charge resets.
If the player is below y=0,
it provides Haste V and Darkness instead.
...
Additionally, hoes with the enchant
replace grass-like blocks with farmland in a 5x3x5 volume around the player
when tilling soil.
