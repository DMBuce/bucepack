...
In addition, grass drops dead bushes when harvested
...
by right-clicking an enderchest with an ender pearl.
...
//Known Issues:
//Ideally, the frienderchest would have a world border,
//but due to
//https://bugs.mojang.com/browse/MC-246429[MC-246429]
//it's surrounded by bedrock instead.
