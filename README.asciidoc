...
* The first time you spawn, you're given a saddle and a mushroom on a stick
* Grindstones can be crafted using a blackstone slab
* There's a chance that crying obsidian will drop lapis when broken

Changes that facilitate survival in The End:

* In addition to slimestone materials, you're given TNT when you respawn
...
Hardcore Lichdom is a challenge datapack designed for hardcore mode. It lets
players who conquer the Illagers, the Ocean, the Wither, and The End
without dying gain immortality and keep their world forever. Advancements
document the basics of the data pack. For more comprehensive documentation,
read on.
