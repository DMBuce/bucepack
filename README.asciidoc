...
bonus spawn chest with one or more of the link::#starter-items[Starter Item]
datapacks below.
...
This is a series of addons datapacks for the
link::#loot-overhaul[Loot Overhaul]
pack above that add one additional item to the bonus spawn chest.
...
Build:
 ...
 make starter_item_bed.zip
 make starter_item_book.zip
 make starter_item_bucket.zip
 make starter_item_map.zip
 make starter_item_shulker.zip
