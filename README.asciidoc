...
Materials obtained by shearing are unchanged, however. For example, you still
need to use shears to obtain wool from sheep.
...
3-5 cobble, 2-3 bread, and 3-5 logs.
