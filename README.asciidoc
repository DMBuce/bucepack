...
Adds arrows to the top of hoppers and the side of observers to make it easier
to see which direction they're pointing.

image::https://i.imgur.com/edmhYeq.png[Tech Arrows Preview]
...
Reverts netherrack to its bloody texture from before 1.14.

image::https://i.imgur.com/WEfv6iZ.png[Retro Netherrack Preview]
