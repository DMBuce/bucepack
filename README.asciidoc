...
//image::https://i.imgur.com/2XApont.png[Volcanic Stony Peaks]
//image::https://i.imgur.com/l3PVJ3p.png[Volcanic Stony Peaks]
//image::https://i.imgur.com/mwejgdG.png[Volcanic Stony Peaks]
image::https://i.imgur.com/DlPJoSW.jpg[Volcanic Stony Peaks]

A new Molten Peaks biome tends to generate near jungles.
It has several layers of smooth basalt on the surface
and several layers of tuff under that.
...
Caves above sea level in Stony Shores, Stony Peaks, Granite Peaks, and Molten Peaks
generate with granite and diorite instead of stone.

Stone ores generate in tuff instead of deepslate ores
