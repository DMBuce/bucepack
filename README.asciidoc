...
* <<mythic-relics,Mythic Relics>>, <<relic-loot,Relic Loot>>, and <<starter-relic,Starter Relic>>: Relics
...
installed, relics have custom item textures in the inventory.
...
Unattaching a lead while sneaking leashes their creatures to you.
...
eats cooked or raw porkchop, they gain Levitation II and Slowness II
for 10 seconds.
...
smithing table. A player can summon a thunderstorm with the trident
...
**Relic of Rodeos**: When a frog eats a silverfish,
it drops a belt buckle with Myth of Roping,
a custom enchantment that can be applied to leather chaps in the smithing
table. When a player wearing the chaps hits one of
