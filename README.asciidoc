...
In addition, this pack contains textures for custom items in the following
datapacks. These textures will only show up if you have one of them installed.

* <<phantasmal,Phantasmal>>
* <<glow-squid-glamers,Glow Squid Glamers>>
* <<invisible-squid-glamer,Invisible Squid Glamer>>
...
Lets you make wood slabs & stairs and smooth & cracked variants in the
stonecutter.

image::https://i.imgur.com/vYQSLNB.png[More Cutting]
...
Light blocks spawn in woodland mansions.
...
custom enchantment that can be applied to leather pants in the smithing
table. When a player
...
**Relic of the Flying Pig**: When a pig with the Levitation effect dies, it
drops a
...
eats cooked or raw porkchop, they gain Levitation for 10 seconds.
...
**Relic of the Burrower**: When a player kills a silverfish with a single
point of damage, it drops a silverfish eye with Myth of Breaking, a custom
...
tool's durability, several extra blocks around the broken block will break.
...
**Relic of Ores**: Deepslate Emerald Ore drops a gold nugget with Myth of
Darkvision and Myth of Mining, two custom enchantments that can be applied to
...
Myth of Mining charges every time a player's pickaxe loses
durability. At 250 charge, the enchantment provides one minute of Haste I, and
the charge resets.

**Relic of the Lens**: When a player with 1 health (half a heart) kills an
endermite in melee combat, it drops an amethyst shard with Myth of Seeking, a
...
Stronghold, End City, or Nether Fortress.
...
**Relic of Disappearance**: When a player kills an invisible phantom, it
drops leather with Curse of Vanishing and Myth of Cloaking, a custom
enchantment that can be applied to elytra in the smithing table. When a player
wearing the elytra takes damage, they gain 8 minutes of invisibility. The
invisibility ends if the player damages a mob.

====

This datapack is not compatible with other datapacks that modify the
Pig, Silverfish, Endermite, Iron Golem, Phantom, or Deepslate Emerald Ore loot
tables.
...
Known Issues: Due to limitations in how Minecraft loot tables work, if you
uninstall this pack and want to continue using Loot Overhaul, Hearts of the
Sea will continue to generate with Myth of Stormcalling until you
run `/function bucepack:loot_overhaul/disable/mythic_relics`
...
When a player hits a phantom, all phantoms near that player turn invisible,
and only their eyes and a faint trail of smoke coming off their wingtips can
be seen.
...
that can be applied to leather pants to give a persistent Speed II effect.
