...
Changes the recipes of some redstone components.
Dispensers use tripwire hooks instead of bows,
and the recipes for activator & detector rails have a stick in the middle.
