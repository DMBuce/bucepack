...
Makes it so that endermen can't pick up blocks such as dirt and grass, and can
pick up more plants and fungi.

Full list of blocks that endermen can pick up in this datapack:
...
* Cactus
* Melons & pumpkins
* Crimson & warped fungus and roots
* Red & brown mushrooms
* TNT
...
Items that are mostly only useful as food such as wheat and bread have been
replaced. Underground structures have potatoes and carrots instead. Villager
and illager structures have pie, cookies, and cake instead.
