...
In this pack, enderman can pick up ferns, dead bushes, grass, flowers,
...
Food looted is themed according to the structure it spawns in. Underground
...
Some highlights of other items you might rarely find in varous structures...
It's possible to find any sapling type in villages and cocoa beans in savanna
villages.
