...
Extract the necessary folders from the new jar:
 ...
 mkdir orig.new
 cd orig.new
 jar xf ~/.minecraft/versions/1.17/1.17.jar data/minecraft/loot_tables/{gameplay,chests}
 mv data/minecraft/loot_tables/* .
 rmdir -p data/minecraft/loot_tables

Append newlines to the new tables so that diff won't complain about newlines
