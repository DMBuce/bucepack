...
custom enchantment that can be applied to leather leggings in the smithing
table. When a player
wearing the leggings takes damage, eats a carrot, or eats rabbit, they gain
...
**Relic of the Flying Pig**: When a pig with the Levitation effect dies, it drops a
...
Rockets shot with such a crossbow gain two randomly generated firework stars.

====

This datapack is not compatible with other datapacks that modify the Iron
Golem or Pig loot tables.
