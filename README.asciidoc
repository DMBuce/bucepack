...
The leather horse armor recipe is changed as well.
...
Adds recipes from bedrock edition.
Craft barrels from sticks and string from cobwebs.
Dye any color of bed or wool.
In addition, you can dye any candle
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/crafting_parity.zip[`crafting_parity.zip`]

=== Plentiful Crafting

Makes the following crafting recipes cheaper.
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/crafting_split.zip[`crafting_split.zip`]
...
image::https://i.imgur.com/vJddlZU.png[Wood Cutting]
...
image::https://i.imgur.com/2ZXAjNt.png[Barrel o' Treasure]
...
See <<barrel-o-treasure,Barrel o' Treasure>> for a version of this pack that's
...
This is a companion pack for the <<loot-overhaul,Loot Overhaul>> datapack
that adds a bonus spawn chest to each player's
...
Direct Link:
https://github.com/DMBuce/bucepack/releases/latest/download/loot_overhaul_barrel_of_treasure.zip[`loot_overhaul_barrel_of_treasure.zip`]
...
Overhauls breeding mechanics for horses, donkeys, mules, llamas.
...
table. When a player
wearing the boots falls 5 blocks, eats a carrot, or eats rabbit, they gain
...
and stone tools are reskinned as copper tools.
To craft your first stone pick, you can use flint.

Chainmail armor is reskinned as copper armor.
Iron armor is reskinned as chainmail,
but is still craftable using iron.
...
and replace bows in the dispenser recipe.
