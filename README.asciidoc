...
It also renames Poppies to Roses when
...
Request if you know how or a GitHub Issue if you don't.
...
When installed as a resource pack, Stonecutters are renamed to Saws when
American English is the selected language in the options menu.
If you would like to add
support for renaming them in other languages, please create a Pull
Request if you know how or a GitHub Issue if you don't.
...
that replaces redstone components with copper variants.
...
//https://i.imgur.com/mHsz7R3.png
//https://i.imgur.com/FvY3I6K.png
image::https://i.imgur.com/PUu0IoJ.png[Copper Tech]
