...
Adds more rain, removes insomnia, and adds new spawning mechanics for
phantoms.

Whenever a player skips the night with a bed, there is an 11% chance of rain.

In addition, phantoms don't spawn in the overworld. Instead, up to three
Mother Phantoms spawn with the Ender Dragon when it's summoned with Ender
Crystals. One Mother Phantom spawns the first time the dragon is summoned, two
spawn the second time, and three Mother Phantoms spawn for each subsequent
dragon fight.

Mother Phantoms are larger than normal, and have extra health.
Whenever a player hits a Mother Phantom, each Mother Phantom has a 25% chance
to spawn a normal phantom.
Mother Phantoms also have a chance to drop their head and/or broken Elytra
enchanted with Curse of Vanishing. Looting increases the drop rate of both items.

Download: https://github.com/DMBuce/bucepack/releases

Build: `make sleep_overhaul.zip`
...
A relic is a shard, trinket, or broken tool with impossible enchants or
attribute modifiers. The latent magic within a relic can be upgraded in the
smithing table with an appropriate tool to create a more useful item.

=== Relic of Knockback

This piece of flint can be upgraded to a Shovel or Hoe with Knockback V.

=== Relic of Endlessness

This stick can be upgraded to a Bow with Infinity and Mending.

=== Relic of Vitality

This glistering melon can be upgraded to a Netherite Chestplate with Vitality
V, an enchantment that grants the wearer five extra hearts.

=== Relic of Speed

This rabbit's foot can be upgraded to Leather Leggings with Speed II, and
enchantment that gives the same benefit as a Speed II potion effect.

=== Relic of Smiting

This bone can be upgraded to a Sword or Axe with Sharpness IV and Smite IV.

=== Relic of Sharpness

The Relic of Sharpness has two forms.

First, as a diamond that can be upgraded to a Pickaxe with Sharpness V.

Second, as a prismarine shard that can be upgraded to a Trident with Sharpness
I.

=== Relic of Frost and Flood

These prismarine crystals can be upgraded to Golden Boots with Frost Walker
II and Depth Strider III.

=== Relic of Protection

This scute can be upgraded to a Turtle Shell with Protection IV and Blast
Protection II.

=== Relic of Striding

This sugar cube can be upgraded to Horse Armor with Depth Strider III and Feather
Falling IV.

=== Relic of Projectile Protection

This piece of leather can be upgraded to Elytra with Projectile Protection II.
