...
Makes furnace minecart useable as train engines.
...
**Relic of Puncheons**:
This lump of coal can be applied to a golden helmet in the smithing table
to give it a custom enchantment called Myth of Train Tunnels.
While riding a minecart in the nether or below y=63 in the overworld,
the helmet consumes sculk from the player's inventory
