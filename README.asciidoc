...
The tools associations that this pack adds are listed here:
...
If the warden is defeated, neutral mobs become angrier.
They will attack players other than the one who angered them
and will continue to attack even if the player they're angry at are dead.

Download: https://github.com/DMBuce/bucepack/releases

Build: `make global_effects.zip`
