...
// loot from a random structure.
// 
// If <<loot-overhaul,Loot Overhaul>> is installed before? after? ... TODO: finish
// end city chests have a chance to generate with 0-12 end portal blocks.
// 
...
// === Hover Mode
// 
// Lets players walk on air and ascend/descend with the jump/sneak keys.
