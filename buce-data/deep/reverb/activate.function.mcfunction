...
execute if score @s var matches 1.. if entity @s[predicate=buce:deep/offhand,predicate=!buce:deep/mainhand] run item replace entity @s weapon.offhand with minecraft:totem_of_undying{relic:1b,reverb:1b,CustomModelData:22183,display:{Name:"{\"text\":\"Relic of Echoes\",\"color\":\"light_purple\"}",Lore:["\"§r§bMyth of Reverberation\""]},Enchantments:[{}]}
execute if score @s var matches 1.. if entity @s[predicate=buce:deep/mainhand] run item replace entity @s weapon.mainhand with minecraft:totem_of_undying{relic:1b,reverb:1b,CustomModelData:22183,display:{Name:"{\"text\":\"Relic of Echoes\",\"color\":\"light_purple\"}",Lore:["\"§r§bMyth of Reverberation\""]},Enchantments:[{}]}
