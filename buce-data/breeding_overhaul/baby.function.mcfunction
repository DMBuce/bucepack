...
tag @s add genes
tag @e[predicate=buce:breeding_overhaul/equine,scores={var=5999},distance=..2.1,limit=2] add genes

# debug
#say I'm being born!
#execute as @e[tag=genes] run say I'm a parent
#execute as @e[predicate=buce:breeding_overhaul/equine,scores={var=5999},distance=..2.1] run tellraw @a ["Age : ",{"score":{"name":"@s","objective":"var"}}]
...
#function buce:breeding_overhaul/debug
...
#execute as @e[predicate=buce:breeding_overhaul/equine,tag=genes,tag=!mutation,scores={var=5999}] run function buce:breeding_overhaul/debug
#tellraw @a ["== Mutation Stats =="]
#execute as @e[predicate=buce:breeding_overhaul/equine,tag=mutation] run function buce:breeding_overhaul/debug

# clean up
execute as @e[type=horse,tag=mutation] run teleport @s ~ ~-255 ~
kill @e[type=horse,tag=mutation]
tag @e[predicate=buce:breeding_overhaul/equine,tag=genes,distance=..2.1] remove genes
