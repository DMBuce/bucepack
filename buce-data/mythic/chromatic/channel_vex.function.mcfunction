...
# revoke advancement
advancement revoke @s only buce:mythic/chromatic/channel_vex
...
# transform the vex
execute as @e[type=vex,distance=..256,nbt={HurtTime:9s}] at @s run function buce:mythic/chromatic/transform_vex
