...
execute anchored eyes store result score @s var run locate structure igloo
execute anchored eyes positioned ^ ^ ^10 store result score #buce.searching_distance var run locate structure igloo
