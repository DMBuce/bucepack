...
# revoke advancement
advancement revoke @s only buce:mythic/searching/nether_fossil/trigger
...
execute anchored eyes store result score @s var run locate structure nether_fossil
execute anchored eyes positioned ^ ^ ^10 store result score #buce.searching_distance var run locate structure nether_fossil
