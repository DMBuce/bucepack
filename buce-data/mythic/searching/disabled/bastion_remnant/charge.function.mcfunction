...
execute anchored eyes store result score @s var run locate structure bastion_remnant
execute anchored eyes positioned ^ ^ ^10 store result score #buce.searching_distance var run locate structure bastion_remnant
