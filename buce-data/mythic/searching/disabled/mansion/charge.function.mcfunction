...
# revoke advancement
advancement revoke @s only buce:mythic/searching/mansion/trigger
advancement revoke @s only buce:mythic/searching/the_overworld/trigger
...
execute anchored eyes store result score @s var run locate structure mansion
execute anchored eyes positioned ^ ^ ^10 store result score #buce.searching_distance var run locate structure mansion
