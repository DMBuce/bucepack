...
# revoke advancement
advancement revoke @s only buce:mythic/searching/shipwreck/trigger
...
execute anchored eyes store result score @s var run locate structure #shipwreck
execute anchored eyes positioned ^ ^ ^10 store result score #buce.searching_distance var run locate structure shipwreck
