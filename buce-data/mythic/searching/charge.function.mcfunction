...
#execute if entity @s[scores={search_charge=20..,var=1..94}] run function buce:mythic/searching/ding
##execute if entity @s[scores={search_charge=15..,var=97..98}] run function buce:mythic/searching/ding
#execute if entity @s[scores={search_charge=10..,var=95..99}] run function buce:mythic/searching/ding
#execute if entity @s[scores={search_charge=2..,var=100..}] run function buce:mythic/searching/ding
##execute if entity @s[scores={search_charge=10..,var=20..}] unless entity @e[type=snowball,tag=searching_eye,distance=50] run function buce:mythic/searching/activate
