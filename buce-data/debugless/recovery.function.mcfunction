...
execute store result score #buce.dx var run data get entity @s LastDeathLocation.pos[0] 1
execute store result score #buce.dy var run data get entity @s LastDeathLocation.pos[1] 1
execute store result score #buce.dz var run data get entity @s LastDeathLocation.pos[2] 1
